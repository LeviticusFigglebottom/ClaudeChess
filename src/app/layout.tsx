        ...
        <PrefsProvider>
          <header className="border-b border-edge">
            <nav className="mx-auto flex max-w-6xl items-center gap-6 px-4 py-3">
              ...
              <span className="cursor-default text-sm text-text-faint" title="Phase 5 — flag-gated">
                Train
              </span>
              <div className="ml-auto">
                <Link href="/engine-check" className="text-xs text-text-faint hover:text-text-dim">
                  engine check
                </Link>
              </div>
            </nav>
